...
//							Log.v(this.getClass().getName(), errmessage);
//							Log.v(this.getClass().getName(), "writNDEFFile error: size / memory issue");
//							Toast toast = Toast.makeText(NFCApplication.getContext(), errmessage, Toast.LENGTH_LONG);
//							toast.show();
//
//							writeStatus = stndefwritestatus.WRITE_STATUS_ERR_MALFORMED_STRUCTURE;
...
//
//							if (cchandler.getMwriteaccess() != 0x00) {
//								writeStatus = stndefwritestatus.WRITE_STATUS_ERR_PASSWORD_REQUIRED;
//								return writeStatus;
//							}
//
//							stnfcm24LRBasicOperation bop = new stnfcm24LRBasicOperation();
...
//
//						} else {
//							String errmessage = "Write NDEF Message issue (CC file): " + " Bytes of msg to Write:" + bufferlength
//									+ " Available bytes space to Write:" + sysHDL.getMemorySize();
//							Log.v(this.getClass().getName(), errmessage);
//							Log.v(this.getClass().getName(), "writNDEFFile error: size / CC file memory issue");
//							Toast toast = Toast.makeText(NFCApplication.getContext(), errmessage, Toast.LENGTH_LONG);
//							toast.show();
//
//							writeStatus = stndefwritestatus.WRITE_STATUS_ERR_MALFORMED_STRUCTURE;
...
//								+ " Available bytes space to Write:" + sysHDL.getMemorySize();
//						Log.v(this.getClass().getName(), errmessage);
//						Log.v(this.getClass().getName(), "writNDEFFile error: size / system memory issue");
//						Toast toast = Toast.makeText(NFCApplication.getContext(), errmessage, Toast.LENGTH_LONG);
//						toast.show();
//
//						writeStatus = stndefwritestatus.WRITE_STATUS_ERR_MALFORMED_STRUCTURE;
...
/*
			...
			// if (msgToWrite.getByteArrayLength() >= this._MemSize) {
			if (bufferlength >= this._MemSize) {
				String errmessage = "Write NDEF Message issue: " + " Bytes of msg to Write:" + bufferlength
						+ " Available bytes space to Write:" + this._MemSize;
				Log.v(this.getClass().getName(), errmessage);
				Log.v(this.getClass().getName(), "writNDEFFile error: IO ERR");
				Toast toast = Toast.makeText(NFCApplication.getContext(), errmessage, Toast.LENGTH_SHORT);
				toast.show();
