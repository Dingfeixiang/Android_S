package com.android.ble.user.util;
...
public class CodeFormat {
     ...
     * @return
     */
    public static String IntegertoFullBinaryStr(int x) {
     ...
     * @return
     */
    public static String hexToStringGBK(String s, int len) {
        byte[] baKeyword = new byte[len];
